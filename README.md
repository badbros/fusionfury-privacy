...
This Service is provided by Bad Bros Studio at no cost and is intended for use as is.
...
When you install and use Bad Bros Studio mobile applications, we can collect and process some of your data for different legitimate purposes.

You will find below explanations regarding the reasons why we may collect data.

### Why is data collected?

Bad Bros Studio and its third-party partners collect data:
...
The third-party partners that Bad Bros Studio will share the data with are:
...
To delete user data collected by Bad Bros Studio, please reach out to badbrothersstudio@gmail.com 
